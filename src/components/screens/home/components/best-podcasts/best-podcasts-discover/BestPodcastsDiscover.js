...
import BestPodcastsDiscoverListItem from './BestPodcastsDiscoverListItem';
...
const BestPodcastsDiscoverList = styled(FlatList)`
  width: 100%;
  flex: 1;
...
export default BestPodcastsDiscover;
